...
public class Main {
    public static void main(String[] args) {
        ...
        Person person1 = new Person("Appa", 10, 5.0, 100.0, 1234567890);
        System.out.println("Person 1's Phone number is " + person1.phoneNumber);
        person1.printPerson();
        System.out.println();
        System.out.println("Person 2");
        Person person2 = new Person("Momo", 5, 3.0, 50.0, 1234567890);
        person2.printPerson();
        ...
        Person person3 = new Person("Korra");
        ...
        Person person4 = new Person("Bolin", 15);
